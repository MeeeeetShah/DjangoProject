...
def index(request):
    ...
    return render(request,'yfapp/index.html',context)
...
def signup(request):
    ...
    return render(request,'yfapp/signup.html',{})
...
def login1(request):
    if request.method == "POST":
        ...
        if user:
            ...
            return redirect('login')
    return render(request,"yfapp/login.html")
...
def videoupload(request):
    ...
    return render(request,'yfapp/videoupload.html',context)
...
def video(request,id):
    ...
    return render(request,'yfapp/video.html',context)
...
def create_channel(request):
    ...
    if youtuber:
        context = {"success":"hai"}
    return render(request,'yfapp/createchannel.html',context)
...
def channel(request):
    ...
    return render(request,'yfapp/channel.html',context)
...
def anychannel(request,id):
    ...
    return render(request,'yfapp/anychannel.html',context)
